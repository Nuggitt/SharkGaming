...
namespace SharkGaming.MockData.MProducts.MComponents.MComponentTypes.MCooling
{
    public class MockCPUAirCooling
    {
        ...
        {
            new CPUAirCooling("Arctic Freezer 34 eSports", 399, true, true, "Great at cooling your CPU" ,"Aluminium",true, "Intel: 1700, 1200, 1155, 1151, 1150, 2066, 2011(-3) AMD: AM5, AM4", 1, 0.6, 120, "4-pin", "1,70", 2100, "1.75m3/h", "00", "Black" ),
            new CPUAirCooling("NOCTUA NH-U12S REDUX CPU COOLER", 449, true, true, "Great at cooling your CPU" ,"Nickel plated Copper (base and heat-pipes), aluminium (cooling fins)",true, "Intel LGA2066, LGA2011-0 & LGA2011-3 (Square ILM), LGA1700, LGA1200, LGA1156, LGA1155, LGA1151, LGA1150 & AMD AM4", 1, 0.6, 120.2, "4-pin", "1,70", 1700, "1.20m3/h", "00", "Black" ),
